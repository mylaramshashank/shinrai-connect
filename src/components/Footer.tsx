    ...
    <footer className="relative bg-gradient-to-t from-card to-background border-t border-primary/20 py-8 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center">
          <p className="text-muted-foreground text-sm md:text-base flex flex-col md:flex-row items-center justify-center gap-2">
            <span>© 2025 Shinrai Connect. All Rights Reserved.</span>
